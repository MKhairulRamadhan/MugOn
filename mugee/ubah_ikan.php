				...
				<div class="col-lg-12 order-2 order-lg-1">
					<form class="checkout-form" enctype="multipart/form-data" method="post">
						...
						<div class="row address-inputs">
							<div class="col-md-12">
								<input type="text" name="nama" value="<?php echo $pecah['nama_ikan']?>" required autocomplete="off">
								<textarea name="deskripsi" required autocomplete="off"><?php echo $pecah['keterangan']?></textarea>
							</div>
							<div class="col-md-6">
								<input class="input_number" type="number" name="harga" value="<?php echo $pecah['harga_ikan']?>" required autocomplete="off">
							</div>
							<div class="col-md-6">
								<input class="input_number" type="number" name="stok" value="<?php echo $pecah['stok_ikan']?>" required autocomplete="off">
							</div>
							<div class="col-md-12">
						...
						<button class="site-btn submit-order-btn" name="ubah">Ubah</button>
					</form>
				</div>
			</div>
		</div>
